...
class BubbleSpecialFour extends StatelessWidget {
  final bool isSender;
  final bool tail;
  final Color color;
  final bool sent;
  ...
  const BubbleSpecialFour({
    Key? key,
    this.isSender = true,
    required this.my_children,
...
class SpecialChatBubbleFour extends CustomPainter {
  final Color color;
  final Alignment alignment;
  final bool tail;

  SpecialChatBubbleFour({
    required this.color,
